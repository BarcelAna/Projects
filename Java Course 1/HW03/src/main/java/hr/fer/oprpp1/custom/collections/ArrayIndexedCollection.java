...
public class ArrayIndexedCollection<E> implements List<E> {
	 ...
	 */
	public ArrayIndexedCollection(Collection<? extends E> otherCollection, int initialCapacity){
	...
	*/
	 ...
	 * @return getter
	 */
	public ElementsGetterArrayList<E> createElementsGetter() {
		ElementsGetterArrayList<E> eg = new ElementsGetterArrayList<>(this);
		return eg;
	}
	 ...
	 *
	 */
	private static class ElementsGetterArrayList<E> implements ElementsGetter<E> {
		/**
		 ...
		 * @param collection
		 */
		public ElementsGetterArrayList(ArrayIndexedCollection<E> collection) {

...
public class LinkedListIndexedCollection implements List {
	 ...
	 */
	@Override
	public ElementsGetterLinkedList createElementsGetter() {
		ElementsGetterLinkedList eg = new ElementsGetterLinkedList(this);
		return eg;
	}
	...
	private static class ElementsGetterLinkedList implements ElementsGetter{
		 ...
		 * @param collection
		 */
		public ElementsGetterLinkedList(LinkedListIndexedCollection col) {
			collection = col;

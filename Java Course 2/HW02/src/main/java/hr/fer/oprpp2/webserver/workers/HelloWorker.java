...
/**
 * HelloWorker represents a web worker which, when called, will produce html page with current date and information about the
 * length of user's name if such parameter was sent in request.
 */

...
/**
 * Class Server is a simple command-line program which represents server listening on given port.
 * It can make connections to client programs and exchange different types of messages.
 */
public class Server {
    /**
     ...
     */
    private Long nextUID = new Random().nextLong();
    ...
    /**
     * Server waits for new messages on given port.
     * If some package is received, server reads it content, process it and send the results back to the client.
     */
    private void listen()  {
        try{
    ...
    private void processHello(Hello m, InetAddress addr, int port) throws IOException {
        ...
        //mora biti synchronized jer imaš dretvu koja sluša na zahtjeve i dretvu koja komunicira sa korisnikom
        //obje pišu, brišu i čitaju clients
